<template>
    <div class="">
        ...
        <div class="container text-center payment-accepted">
            <div class="row">
                <div class="col">
                    <i class="bollino-maledetto fa-solid fa-check"></i>
                </div>
            </div>
            <div class="col">
                <h1>Ordine Inserito con Successo!</h1>
            </div>
            <div class="col">
                A breve riceverai una mail con i dettagli del tuo ordine
            </div>
        </div>
    </div>
</template>
...
.payment-accepted {
    height: calc(100vh - 120px - 100px - 170px);
}
    .bollino-maledetto {
