...
<form action="{{route('admin.dishes.store')}}" enctype="multipart/form-data" method="POST">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="description" required rows="3" name="description">{{$dish->description}}</textarea>
    </div>
    @error('description')
        <div class="mt-2 alert alert-danger">
            {{$message}}
    ...
    <div class="mb-3">
        ...
        <input  step="0.01" type="number" class="form-control" required id="price" name="price" value="{{$dish->price}}">
    </div>
    @error('price')
        <div class="mt-2 alert alert-danger">
            {{$message}}
    ...
    @else 
        <img class="img-fluid" src="{{asset("storage/default-placeholder.png")}}" alt="">
    @endif
    <div class="mb-3">
